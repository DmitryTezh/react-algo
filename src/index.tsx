...
const keyPair = Crypto.generateKeys({ keyLength: 20, includePrimesInPrivateKey: true });
const encrypted = Crypto.encrypt(123456789, keyPair.publicKey);
const decrypted = Crypto.decrypt(encrypted, keyPair.privateKey);
console.warn(keyPair);
console.warn('123456789 -> %s -> %s', encrypted, decrypted);
